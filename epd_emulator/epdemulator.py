...
class EPD:
    ...
    def init_flask(self):
        ...
        def display_image():
            try:
                response = send_file(os.path.join(os.path.dirname(__file__), 'screen.png'), mimetype='image/png')
    ...
    def Clear(self, color):
        ...
        self.draw = ImageDraw.Draw(self.image)  
        self.update_image_bytes()  # Ensure the screen updates
    ...
    def paste_image(self, image, box=None, mask=None):
        """Correctly paste an image onto the simulated e-paper display."""
